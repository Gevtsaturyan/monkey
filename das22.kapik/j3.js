...
document.onkeydown=function(e){
    var kapikl1=document.getElementById('kapik3').offsetLeft
    var kapikt1=document.getElementById('kapik3').offsetTop
    ...
    if(e.keyCode == 38){
        kapikt1=kapikt1-5
        document.getElementById('kapik3').style.top=kapikt1+'px'
    ...
    if(e.keyCode == 37){
        kapikl1=kapikl1-5
        document.getElementById('kapik3').style.left=kapikl1+'px'
