...
document.onkeydown=function(e){
    var kapikl1=document.getElementById('kapik1').offsetLeft
    var kapikt1=document.getElementById('kapik1').offsetTop
    ...
    if(e.keyCode == 38){
        kapikt1=kapikt1-5
        document.getElementById('kapik1').style.top=kapikt1+'px'
    ...
    if(e.keyCode == 37){
        kapikl1=kapikl1-5
        document.getElementById('kapik1').style.left=kapikl1+'px'
    ...
    if(kapikl1+70>banan1l && kapikl1<banan1l+70 && kapikt1 + 70>banan1t && kapikt1<banan1t+70 ){
        ...
        document.getElementById('kapik1').style.backgroundImage='url(img/yem1.gif)'
        setTimeout(()=>{
            document.getElementById('kapik1').style.backgroundImage='url(img/nachat2.gif)'
        },700)
    ...
    if(kapikl1+80>leonl && kapikl1<leonl+80 && kapikt1 + 80>leont && kapikt1<leont+80 ){
        ...
        document.getElementById('kapik1').style.display='none'
    }

    if(kapikl1+80>ocl && kapikl1<ocl+80 && kapikt1 + 80>oct && kapikt1<oct+80 ){
        document.getElementById('over').style.opacity=1;
        document.getElementById('kapik1').style.display='none'
    }

    if(kapikl1+80>orioll && kapikl1<orioll+80 && kapikt1 + 80>oriolt && kapikt1<oriolt+80 ){
        document.getElementById('over').style.opacity=1;
        document.getElementById('kapik1').style.display='none'
    }
